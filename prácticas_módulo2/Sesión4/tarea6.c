...
int main(int argc, char *argv[]){
  ...
  if (PID == 0) {
    //Cierre del descriptor de lectura en el proceso hijo, porque vamos a escribir
    close(fd[0]);
    ...
    //Cerrar el descriptor de escritura en el proceso padre, porque vamos a leer
    close(fd[1]);
    //Leer los datos que ha mandado el hijo desde el cauce
